...
for (let i = 0; i < picArray.length; i++) {
  ...
  images.src = picArray[i].image.medium;
  images.alt = picArray[i].title || "image";
  caption.textContent = picArray[i].caption;

  title.textContent = picArray[i].title;
  dscr.textContent = picArray[i].description;
  ...
  article.appendChild(dscr);

  article.addEventListener("click", () => {
    dialogImage.src = picArray[i].image.large;
    dialogImage.alt = picArray[i].title || "Image";
    dialog.showModal();
  });
